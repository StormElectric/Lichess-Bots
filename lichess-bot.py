...
def play_game(li, game_id, control_queue, engine_factory, user_profile, config, challenge_queue, correspondence_queue, logging_queue, logging_configurer, logging_level):
    ...
    conversation.send_reply(SendLine('player'), f'Hello {opponent}, Welcome to the game, Good luck! Type !help for a list of commands I can respond to.')
    ...
    conversation.send_reply(SendLine('player'), f'Good game! Thanks for playing with me!')
